...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "kad5wpmhssycwm98qx7gdjsxsyewm1zw73prpfxcnzn28enesum0",
  ...
  manifest = (
    ...
    actions = [
      ...
      ( title = (defaultText = "New Tabulas game"),
        command = .myCommand
    ...
    metadata = (
      ...
      shortDescription = (defaultText = "Race writing game"),
